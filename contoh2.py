...
data = [
    ...
    (58, 'Ce', 'Serium', 140.12, 'Tidak ada', 8, 'Lantanida'),
    (59, 'Pr', 'Praseodimium', 140.91, 'Tidak ada', 8, 'Lantanida'),
    (60, 'Nd', 'Neodimium', 144.24, 'Tidak ada', 8, 'Lantanida'),
    (61, 'Pm', 'Prometium', 145.0, 'Tidak ada', 8, 'Lantanida'),
    (62, 'Sm', 'Samarium', 150.36, 'Tidak ada', 8, 'Lantanida'),
    (63, 'Eu', 'Europium', 151.96, 'Tidak ada', 8, 'Lantanida'),
    (64, 'Gd', 'Gadolinium', 157.25, 'Tidak ada', 8, 'Lantanida'),
    (65, 'Tb', 'Terbium', 158.93, 'Tidak ada', 8, 'Lantanida'),
    (66, 'Dy', 'Disprosium', 162.5, 'Tidak ada', 8, 'Lantanida'),
    (67, 'Ho', 'Holmium', 164.93, 'Tidak ada', 8, 'Lantanida'),
    (68, 'Er', 'Erbium', 167.26, 'Tidak ada', 8, 'Lantanida'),
    (69, 'Tm', 'Tulium', 168.93, 'Tidak ada', 8, 'Lantanida'),
    (70, 'Yb', 'Iterbium', 173.05, 'Tidak ada', 8, 'Lantanida'),
    (71, 'Lu', 'Lutesium', 174.97, 3.0, 6, 'Lantanida'),
    (89, 'Ac', 'Aktinium', 227.0, 3.0, 7, 'Aktinida'),
    (90, 'Th', 'Torium', 232.04, 'Tidak ada', 9, 'Aktinida'),
    (91, 'Pa', 'Protaktinium', 231.04, 'Tidak ada', 9, 'Aktinida'),
    (92, 'U', 'Uranium', 238.03, 'Tidak ada', 9, 'Aktinida'),
    (93, 'Np', 'Neptunium', 237.0, 'Tidak ada', 9, 'Aktinida'),
    (94, 'Pu', 'Plutonium', 244.0, 'Tidak ada', 9, 'Aktinida'),
    (95, 'Am', 'Amerisium', 243.0, 'Tidak ada', 9, 'Aktinida'),
    (96, 'Cm', 'Kurium', 247.0, 'Tidak ada', 9, 'Aktinida'),
    (97, 'Bk', 'Berkelium', 247.0, 'Tidak ada', 9, 'Aktinida'),
    (98, 'Cf', 'Kalifornium', 251.0, 'Tidak ada', 9, 'Aktinida'),
    (100, 'Fm', 'Fermium', 257.0, 'Tidak ada', 9, 'Aktinida'),
    (101, 'Md', 'Mendelevium', 258.0, 'Tidak ada', 9, 'Aktinida'),
    (102, 'No', 'Nobelium', 259.0, 'Tidak ada', 9, 'Aktinida'),
